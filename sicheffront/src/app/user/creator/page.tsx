        ...
        <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="sticky top-28 flex flex-col items-center lg:items-start">
              <div className="relative mb-8">
                <div
                  ...
                  style={{
                    backgroundImage: `url('https://images.unsplash.com/photo-1577214459173-938670172606?w=400')`,
                  }}
                />
                <div className="absolute -bottom-2 -right-2 bg-[#F57C00] text-[#181411] p-2 rounded-2xl border-4 border-[#181411] shadow-xl">
                  <span className="material-symbols-outlined text-[22px] font-bold block">
                    check_circle
                  </span>
                </div>
              </div>

              <h1 className="text-4xl font-black text-[#e6e0db] mb-2 tracking-tight">
                Chef Maria
              </h1>
              <p className="text-[#e6e0db]/60 text-lg mb-8 leading-relaxed max-w-sm">
                Especialista en técnica{" "}
                <span className="text-[#F57C00]">slow-food</span> y pastas
                artesanales.
              </p>
          ...
          <section className="lg:w-2/3">
            ...
            <div className="flex gap-2 p-1.5 bg-[#2a221b] rounded-2xl mb-10 w-fit">
              <button className="px-8 py-3 rounded-xl bg-[#F57C00] text-[#e6e0db] font-bold shadow-lg">
                Recetas
              </button>
              <button className="px-8 py-3 rounded-xl text-[#e6e0db]/50 font-bold hover:text-[#e6e0db] transition-colors">
                Tutoriales
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="col-span-full bg-gradient-to-br from-[#F57C00] to-[#ff9800] rounded-[2rem] p-8 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative group">
                ...
                <div className="z-10">
                  <h3 className="text-[#181411] text-2xl font-black mb-2">
                    Masterclass Presencial
                  </h3>
                  <p className="text-[#181411]/80 font-medium">
                    Aprende a dominar el fuego y la masa este sábado.
                  </p>
                </div>
...
function StatItem({ value, label }) {
  return (
    <div className="text-center py-4 rounded-2xl hover:bg-[#181411]/40 transition-colors">
      ...
      <p className="text-[10px] font-bold uppercase tracking-widest text-[#e6e0db]/40">
        {label}
      </p>
    </div>
  );
    ...
    <div className="group bg-[#2a221b] rounded-[2rem] overflow-hidden border border-[#e6e0db]/5 hover:border-[#F57C00]/30 transition-all duration-500">
      <div className="relative aspect-[4/5] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 bg-[#181411]/80 backdrop-blur-md px-3 py-1 rounded-full border border-[#e6e0db]/10">
          <span className="text-[10px] font-bold text-[#F57C00] tracking-widest uppercase">
            {level}
          </span>
        </div>
        ...
        <div className="absolute bottom-6 left-6 right-6">
          <div className="flex items-center gap-2 text-[#e6e0db]/70 text-xs font-bold mb-2 uppercase tracking-tighter">
            <span className="material-symbols-outlined text-sm text-[#F57C00]">
              schedule
            </span>
            {time}
          </div>
