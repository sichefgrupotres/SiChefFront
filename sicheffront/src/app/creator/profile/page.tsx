...
//             ) : (
//               <div className="text-center text-gray-500 py-16 bg-[#2a221b]/30 rounded-xl border border-gray-800 border-dashed">
//                 <p>No tienes recetas pendientes por revisión.</p>
//               </div>
//             )}
//           </div>
//         )}
