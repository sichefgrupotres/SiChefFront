            ...
            <main className="max-w-7xl mx-auto">
                ...
                <section className="px-4 md:px-8 pb-12">
                    <div className="relative overflow-hidden rounded-2xl bg-surface-dark min-h-[480px]">
                        ...
                        <div className="relative z-10 p-6 md:p-16 flex flex-col justify-end min-h-[480px]">
                            <span className="bg-primary text-white text-xs font-bold px-3 py-1 rounded-full w-fit mb-4">
                                Premium
                            </span>

                            <h1 className="text-4xl md:text-6xl font-extrabold mb-4">
                                Domina el Arte del <span className="text-primary">Risotto Perfecto</span>
                            </h1>

                            <p className="text-gray-300 max-w-xl mb-8">
                                Accedé a tutoriales exclusivos paso a paso con chefs profesionales.
                            </p>
                ...
                <section className="px-4 md:px-8 pb-8">
                    ...
                    <div className="flex gap-4 overflow-x-auto">
                        {["Desayunos", "Almuerzos", "Meriendas", "Cenas", "Postres",].map((cat) => (
                            <div
                                key={cat}
                                className="min-w-[140px] h-24 bg-black/40 rounded-xl flex items-center justify-center text-white font-bold"
                            >
                                {cat}
                            </div>
                        ))}
                ...
                <section className="px-4 md:px-8 pb-16">
                    <h2 className="text-2xl font-bold mb-6 text-white">Tendencias de la semana</h2>
